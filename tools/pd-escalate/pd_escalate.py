...
PD_BASE_URL = "https://tmtoc.pagerduty.com/incidents"

# Jira web UI base URL
JIRA_BASE_URL = "https://jira.livenation.com/browse"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  %(prog)s --pd https://tmtoc.pagerduty.com/incidents/Q33L5GALLQ3ESB --dssd DSSD-29386 --dry-run\n"
